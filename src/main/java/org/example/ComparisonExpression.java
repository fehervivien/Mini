...
/**
 * Egy összehasonlító műveletet reprezentál.
 * MÓDOSÍTÁS: Típusellenőrzést végez.
 * '==' és '!=' működik stringekre és számokra is.
 * A többi (>, <, stb.) csak számokra.
 */
public class ComparisonExpression implements Expression {
    ...
    public Object evaluate(Environment env) {
        ...
        // 3. Eset: Típusok keverése (pl. String és Double)
        else {
            // '==' és '!=' esetén is hamisat adunk vissza,
            // mivel egy string soha nem egyenlő egy számmal.
            switch (operator) {
        ...
        // Az eredményt (boolean) átalakítjuk a nyelvünk szám-reprezentációjára
