...
public class VarAssignStatement implements Statement {
    ...
    public void execute(Environment env) {
        ...
        /* 2. LÉPÉS: A kiszámolt értéket eltárolja
        a környezetben. A setVariable metódus tudja
        hogy ha a változó még nem létezik,létrehozza
        (Deklaráció), ha pedig már létezik, akkor
        felülírja a korábbi értékét (Értékadás).*/
